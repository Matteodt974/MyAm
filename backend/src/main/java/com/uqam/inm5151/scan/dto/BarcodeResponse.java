 ...
 *
 * <p>Les cles JSON sont identiques au backend FastAPI : snake_case pour
 * {@code nova_group}, {@code additives_tags} et {@code allergens_tags}. Les champs nuls sont
 * conserves dans la reponse (comme FastAPI) grace a {@code JsonInclude.Include.ALWAYS}.</p>
 */
